...
export const env = createEnv({
  ...
  server: {
    ...
    GATEWAYZ_API_KEY:                      z.string().min(1).optional(),           // Gatewayz.ai API key for unified inference
    GATEWAYZ_BASE_URL:                     z.string().url().optional(),            // Gatewayz.ai base URL for API calls
